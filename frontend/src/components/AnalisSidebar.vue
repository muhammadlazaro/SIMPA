...
const menuItems = [
  {
    name: 'Antrian analisa',
    titleCollapsed: 'Antrian analisa - aplikasi pada tahap Analisa & Desain',
    icon: 'apps',
    path: '/analis-desain',
    exact: false,
  },
...
function handleNotifClick(notif) {
  ...
  if (notif.aplikasi_id) {
    router.push({ name: 'analis-desain-app-detail', params: { id: notif.aplikasi_id } })
  }
  closeNotifDropdown()
}
    ...
    <div class="sidebar-footer">
      ...
      <div class="user-section">
        ...
        <div v-if="!isCollapsed" class="user-info">
          ...
          <div class="user-role">{{ ROLE_DISPLAY_NAME[auth.role] || auth.role }}</div>
        </div>
      </div>
